...
const BSC_EVM_CHAIN_ID: Record<ChainflipNetwork, number> = {
  backspin: 343, // localnet bsc
  sisyphos: 97, // bsc testnet
  perseverance: 97, // bsc testnet
...
export const getEvmChainId = (chain: ChainflipChain, network: ChainflipNetwork) => {
  switch (chain) {
    ...
    case 'Bsc':
      return BSC_EVM_CHAIN_ID[network];
    default:
      return undefined;
  }
};
...
const SEPOLIA_CBBTC_CONTRACT_ADDRESS = '0xcbB7C0006F23900c38EB856149F799620fcb8A4a';
const BSC_TESTNET_USDT_CONTRACT_ADDRESS = '0x337610d27c682E347C9cD60BD4b3b107C9d34dDd';
...
type AddressMap = {
  ...
  BSCUSDT_CONTRACT_ADDRESS: string;
};
...
export const ADDRESSES: Record<ChainflipNetwork, AddressMap> = {
  backspin: {
    ...
    CBBTC_CONTRACT_ADDRESS: '0xE6E340D132b5f46d1e472DebcD681B2aBc16e57E',
    ...
    TRXUSDT_CONTRACT_ADDRESS: 'TWLpd9LSUJgdVcqxrg2MYnXq7Spkx5r9oz', // TRON USDT contract can change on backspin if the tron image is rebuilt
    BSCUSDT_CONTRACT_ADDRESS: '0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9',
  },
  sisyphos: {
    ...
    CBBTC_CONTRACT_ADDRESS: SEPOLIA_CBBTC_CONTRACT_ADDRESS,
    ...
    TRXUSDT_CONTRACT_ADDRESS: 'TXYZopYRdj2D9XRtbG411XZZ3kM5VkAeBf',
    BSCUSDT_CONTRACT_ADDRESS: BSC_TESTNET_USDT_CONTRACT_ADDRESS,
  },
  perseverance: {
  ...
  mainnet: {
    ...
    TRXUSDT_CONTRACT_ADDRESS: 'TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t',
    BSCUSDT_CONTRACT_ADDRESS: '0x55d398326f99059fF775485246999027B3197955',
  },
};
