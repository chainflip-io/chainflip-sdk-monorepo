...
export type GetBatchQuery = { blocks: { nodes: Array<{ height: number, hash: string, timestamp: any, specId: string, events: { nodes: Array<{ args: any, name: string, indexInBlock: number }> } }> } | null };
...
export type GetCallQuery = { call: { args: any } | null };
...
export type GetExtrinsicQuery = { extrinsic: { signature: any } | null };
