...
import { swappingCreditedOnChain as schema230 } from '@chainflip/processor/230/swapping/creditedOnChain';
import { z } from 'zod';
import { EventHandlerArgs } from '../index.js';

const swappingCreditedOnChain = z.union([schema230.strict(), schema220.strict()]);
