...
export default z
  .object({
    ...
    ENABLE_QUOTE_MESSAGE_QUEUE: optionalBoolean.default('false'),
    CHECK_ALL_LPS_FOR_LIQUIDITY: optionalBoolean.default('false'),
    ...
    NOT_FOUND_RATE_LIMIT_MAX_REQUESTS: optionalNumber(10),
